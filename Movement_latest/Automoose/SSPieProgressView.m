...
- (void)_initialize {
	...
	self.progress = 0.0f;
	self.pieBorderWidth = 0.0f;
	self.pieBorderColor = [[self class] defaultPieColor];
	self.pieFillColor = [AMUtility getColorwithRed:229 green:229 blue:229];
//    [AMUtility getColorwithRed:100 green:137 blue:237];
	self.pieBackgroundColor =[AMUtility getColorwithRed:100 green:137 blue:237];
//    [AMUtility getColorwithRed:53 green:108 blue:210];
}
